...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
      ...
      self.profilePic = [[UIImageView alloc] initWithFrame:CGRectMake(padding, padding, 70, 70)];
...
//      self.notificationText.backgroundColor = [UIColor redColor];
      ...
      self.timeStamp = [[UILabel alloc] initWithFrame:CGRectMake(self.notificationIcon.frame.origin.x + self.notificationIcon.frame.size.width + grid, self.notificationIcon.frame.origin.y, self.frame.size.width - (self.notificationIcon.frame.origin.x + self.notificationIcon.frame.size.width) - padding - gutter, 16)];
